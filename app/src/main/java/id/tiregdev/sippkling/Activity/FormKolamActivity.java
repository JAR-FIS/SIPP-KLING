...
public class FormKolamActivity extends AppCompatActivity {
    ...
    private void setInit() {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final LayoutInflater factory = LayoutInflater.from(FormKolamActivity.this);
                final View exitDialogView = factory.inflate(R.layout.popup_yakin, null);
                final AlertDialog exitDialog = new AlertDialog.Builder(FormKolamActivity.this).create();
    ...
    private void onSubmit() {
        if(!frmNamaTempat.getText().toString().trim().equals("") && !frmNamaPengusaha.getText().toString().trim().equals("")
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.SEND_DATA_KOLAM, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    dialogUtil.showDialog(FormKolamActivity.this, finalStatus);
