...
public class FormRumahsakitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_rumahsakit);
    ...
    private void setInit() {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final LayoutInflater factory = LayoutInflater.from(FormRumahsakitActivity.this);
                final View exitDialogView = factory.inflate(R.layout.popup_yakin, null);
                final AlertDialog exitDialog = new AlertDialog.Builder(FormRumahsakitActivity.this).create();
    ...
    private void onSubmit() {
        if(!frmNamaTempat.getText().toString().trim().equals("") && !frmAlamat.getText().toString().trim().equals("") &&
            ...
            final String namaRS = frmNamaTempat.getText().toString().trim();
            final String kelasRS = ((RadioButton)findViewById(rgKelas.getCheckedRadioButtonId())).getText().toString();
            final String alamat = frmAlamat.getText().toString().trim();
            final String jumlahTempatTidur = frmJmlTempat.getText().toString().trim();
            ...
            final String[] nilaiCB = new String[cb.length];
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.SEND_DATA_RUMAHSAKIT, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    dialogUtil.showDialog(FormRumahsakitActivity.this, finalStatus);
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("jumlah_tempat_tidur", jumlahTempatTidur);
                    params.put("kelas_rs", kelasRS);
                    params.put("koordinat", koordinat);
                    params.put("nama_tempat", namaRS);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                FormRumahsakitActivity.this.finish();
                return true;
            default:
