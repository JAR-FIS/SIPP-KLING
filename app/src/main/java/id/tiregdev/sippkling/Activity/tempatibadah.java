...
public class tempatibadah extends AppCompatActivity {
    ...
    private List<object_dataObyek> getAllItemList() {
        ...
        allItems.add(new object_dataObyek("Masjid An Nur", "Ahmad Abdul", getResources().getString(R.string.almt1), "06/11/2017", "Layak"));
        allItems.add(new object_dataObyek("Masjid At Taqwa", "Abu Abdul", getResources().getString(R.string.almt2), "10/10/2017", "Layak"));
        allItems.add(new object_dataObyek("Masjid Nurul Huda", "Muhammad Abdul", getResources().getString(R.string.almt3), "12/10/2017", "Tidak Layak"));
        allItems.add(new object_dataObyek("Mushollah Al Barkah", "Al Abdul", getResources().getString(R.string.almt1), "12/10/2017", "Layak"));
        allItems.add(new object_dataObyek("Gereja ST. Maria", "Si Abdul", getResources().getString(R.string.almt2), "12/10/2017", "Tidak Layak"));
        allItems.add(new object_dataObyek("Mushollah Al Fajr", "Dul Abdul", getResources().getString(R.string.almt3), "13/10/2017", "Layak"));
        allItems.add(new object_dataObyek("Masjid Baiturrahman", "Koh Abdul", getResources().getString(R.string.almt1), "15/10/2017", "Tidak Layak"));
