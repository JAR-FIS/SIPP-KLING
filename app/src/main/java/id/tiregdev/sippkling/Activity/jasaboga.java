...
public class jasaboga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jasaboga);
        ...
        tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final LayoutInflater factory = LayoutInflater.from(jasaboga.this);
                final View exitDialogView = factory.inflate(R.layout.popup_tambahdata, null);
                final AlertDialog exitDialog = new AlertDialog.Builder(jasaboga.this).create();
                ...
                exitDialogView.findViewById(R.id.ya).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        exitDialog.dismiss();
                        Intent i = new Intent(jasaboga.this, form_jasaboga.class);
                        startActivity(i);
                    }
                });
                exitDialog.show();
    ...
    private List<object_dataObyek> getAllItemList() {
        ...
        allItems.add(new object_dataObyek("RM Minangkabau", "Abu Abdul", getResources().getString(R.string.almt2), "10/10/2017", "Baik"));
        allItems.add(new object_dataObyek("WhatsApp Cafe", "Muhammad Abdul", getResources().getString(R.string.almt3), "12/10/2017", "Baik"));
        allItems.add(new object_dataObyek("Alibubu", "Al Abdul", getResources().getString(R.string.almt1), "12/10/2017", "Baik"));
