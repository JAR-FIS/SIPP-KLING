...
public class form_rumahsehat extends AppCompatActivity {
    ...
    private static final String TAG = form_rumahsehat.class.getSimpleName();
    ...
    private void sendData(){
        ...
        if(hasValue){
            final String pushRS = "#editheretoo";
            ...
            if(spinnerSAB.getSelectedItemPosition() == 0){
                ...
                Intent intent = new Intent(getBaseContext(), form_sabpompa.class);
                ...
                Toast.makeText(this, "Data berhasil dikirim!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getBaseContext(), form_sab_sumurgali.class);
                intent.putExtra("idSAB", idSAB);
                intent.putExtra("idRS", pushRS);
                intent.putExtra("koordinat", koordinat);
                intent.putExtra("alamat", frmAlamat.getText().toString().trim());
                ...
                Toast.makeText(this, "Data berhasil dikirim!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getBaseContext(), form_sab_sumurgaliplus.class);
                intent.putExtra("idSAB", idSAB);
                intent.putExtra("idRS", pushRS);
                intent.putExtra("koordinat", koordinat);
                intent.putExtra("alamat", frmAlamat.getText().toString().trim());
