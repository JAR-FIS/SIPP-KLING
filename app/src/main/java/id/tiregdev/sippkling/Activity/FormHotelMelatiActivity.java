...
public class FormHotelMelatiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_hotelmelati);
    ...
    private void setInit() {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final LayoutInflater factory = LayoutInflater.from(FormHotelMelatiActivity.this);
                final View exitDialogView = factory.inflate(R.layout.popup_yakin, null);
                final AlertDialog exitDialog = new AlertDialog.Builder(FormHotelMelatiActivity.this).create();
    ...
    private void onSubmit() {
        if(!frmNamaTempat.getText().toString().trim().equals("") && !frmNamaPengusaha.getText().toString().trim().equals("")
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.SEND_DATA_HOTELMELATI, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    dialogUtil.showDialog(FormHotelMelatiActivity.this, finalStatus);
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("nama_pimpinan", namaPengelola);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                FormHotelMelatiActivity.this.finish();
                return true;
            default:
