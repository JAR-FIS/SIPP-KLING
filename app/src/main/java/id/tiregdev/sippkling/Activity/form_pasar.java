...
public class form_pasar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final LayoutInflater factory = LayoutInflater.from(form_pasar.this);
                final View exitDialogView = factory.inflate(R.layout.popup_yakin, null);
                final AlertDialog exitDialog = new AlertDialog.Builder(form_pasar.this).create();
                ...
                exitDialogView.findViewById(R.id.ya).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final AlertDialog exitDialogs = new AlertDialog.Builder(form_pasar.this).create();
                        exitDialogs.setView(exitDialogView);
                        exitDialogView.findViewById(R.id.sukses).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                exitDialogs.dismiss();
                                Toast.makeText(form_pasar.this, "Pengisian Sukses", Toast.LENGTH_SHORT).show();
                                form_pasar.this.finish();
                            }
                        });
                        exitDialogs.show();
                    }
