...
public class FormPuskesmasActivity extends AppCompatActivity {


    EditText frmNamaTempat, frmNamaPengelola, frmAlamat;
    Button btnSend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_puskesmas);
    ...
    private void setInit() {
        ...
        frmNamaPengelola = (EditText)findViewById(R.id.namaPimpinan);
        frmAlamat = (EditText)findViewById(R.id.alamat);

        btnSend = (Button)findViewById(R.id.send);

        for(int i=0;i<cb.length;i++){
            int rID = getResources().getIdentifier("pm" + (i + 1), "id", this.getBaseContext().getPackageName());
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final LayoutInflater factory = LayoutInflater.from(FormPuskesmasActivity.this);
                final View exitDialogView = factory.inflate(R.layout.popup_yakin, null);
                final AlertDialog exitDialog = new AlertDialog.Builder(FormPuskesmasActivity.this).create();
    ...
    private void onSubmit() {
        if(!frmNamaTempat.getText().toString().trim().equals("") && !frmNamaPengelola.getText().toString().trim().equals("")
            ...
            final String namaPuskesmas = frmNamaTempat.getText().toString().trim();
            final String namaPimpinan = frmNamaPengelola.getText().toString().trim();
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.SEND_DATA_PUSKESMAS, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    dialogUtil.showDialog(FormPuskesmasActivity.this, finalStatus);
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("nama_pimpinan", namaPimpinan);
                    params.put("koordinat", koordinat);
                    params.put("nama_tempat", namaPuskesmas);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                FormPuskesmasActivity.this.finish();
                return true;
            default:
