...
public class pesantren extends AppCompatActivity {
    ...
    private void displayData(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(AppConfig.DISPLAY_DATA + "?kategori=pesantren&id=" + db.getUserDetails().get("id_petugas"), new Response.Listener<JSONArray>() {
            @Override
