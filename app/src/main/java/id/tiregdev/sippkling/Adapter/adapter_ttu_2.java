...
public class adapter_ttu_2 extends RecyclerView.Adapter<adapter_ttu_2.holder_jasaboga> {

    private List<object_dataObyek> itemList;
    private Context context;

    public adapter_ttu_2(Context context, List<object_dataObyek> itemList){
    ...
    public holder_jasaboga onCreateViewHolder(ViewGroup parent, int viewType){
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_ttu_dua,null);
    ...
    public class holder_jasaboga extends RecyclerView.ViewHolder {
        ...
        public holder_jasaboga(View itemView){
            ...
            identitas = itemView.findViewById(R.id.namaPimpinan);
