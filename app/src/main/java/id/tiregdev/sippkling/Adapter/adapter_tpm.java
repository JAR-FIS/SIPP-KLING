...
public class adapter_tpm extends RecyclerView.Adapter<adapter_tpm.holder_jasaboga> {

    private List<object_dataObyek> itemList;
    private Context context;

    public adapter_tpm(Context context, List<object_dataObyek> itemList){
    ...
    public holder_jasaboga onCreateViewHolder(ViewGroup parent, int viewType){
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_tpm,null);
