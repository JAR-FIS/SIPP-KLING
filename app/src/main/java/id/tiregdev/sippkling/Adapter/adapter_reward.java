...
public class adapter_reward extends RecyclerView.Adapter<adapter_reward.holder_reward> {

    private List<object_reward> itemList;
    private Context context;

    public adapter_reward(Context context, List<object_reward> itemList){
