...
public class JadwalAdapter extends RecyclerView.Adapter<JadwalAdapter.holder_jadwal> {

    private List<JadwalModel> itemList;
    private Context context;

    public JadwalAdapter(Context context, List<JadwalModel> itemList){
