...
public class adapter_history extends RecyclerView.Adapter<adapter_history.holder_history> {

    private List<object_history> itemList;
    private Context context;

    public adapter_history(Context context, List<object_history> itemList){
